#!/usr/bin/env python3
"""
VPN Hybrid Proxy Server — Windows Edition
===========================================
Runs an HTTP CONNECT proxy and a SOCKS5 proxy at the same time, on two
separate ports, sharing the same VPN connection.
...
# ── SOCKS5 proxy (TCP + UDP — required for NAT Type) ──────────────────
